...
class temporalFrame: 
    def __init__(self, window, width, height, parent ):
        ...
        self.attackerControls = Image.open("Code/GraphicalUserInterface/GameData/Control-Attacker2.png").resize((700,700))
        self.attackerControls = ImageTk.PhotoImage(self.attackerControls)

        self.defenderControls = Image.open("Code/GraphicalUserInterface/GameData/Control-Defender2.png").resize((700,700))
